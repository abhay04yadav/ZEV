...
export const productPages = {
  'camera-laptop': {
    ...
    desc: [
      ...
      'ZEV serves as an accredited reseller with a focus on renowned technology brands such as Lenovo, HP, Dell, and Acer for laptops, Sony and Canon for cameras, and HP and Brother for printers and CCTV.',
    ],
    feats: [
      'Laptops & computers — Lenovo, HP, Dell, Acer and more',
      'Cameras & computer accessories — Sony, Canon and others',
      'Printers — authorized HP and Brother reseller',
      'CCTV cameras for commercial, residential and school use',
      'IT solutions, software and technical support across UAE',
    ],
    values: [
      { icon: 'shield', title: 'Authorized Reseller', desc: 'Genuine devices from Lenovo, HP, Dell, Acer, Sony and Canon with full manufacturer warranty.' },
      { icon: 'clock', title: 'Full Range', desc: 'Laptops, cameras, printers and CCTV — all technology needs under one supplier.' },
      { icon: 'sliders', title: 'IT Solutions', desc: 'Software, programs and complete IT solutions for organizations across the UAE.' },
    ],
    gallery: ['1496181133206-80ce9b88a853', '1502920917128-1aa500764cbd', '1517336714731-489689fd1ca8', '1526170375885-4d8ecf77b99f'],
    galleryAlts: ['High-performance laptop', 'Professional camera', 'Modern laptop setup', 'Camera & lenses'],
    related: [
  ...
  'corporate-gifts': {
    ...
    desc: [
      ...
      'Choose from our range of sophisticated and meaningful corporate gifts to leave a lasting impression. We also supply products based on your own design — elevate your gifting experience with ZEV.',
    ],
    feats: [
      'Curated premium corporate gift sets',
      'Custom branding — logo printing & engraving',
      'Products designed to your specification',
      'Branded bags, stationery & accessories',
      'Bulk orders for events, campaigns & seasons',
    ],
    values: [
      { icon: 'shield', title: 'On Brand', desc: 'From logo printing to products built around your own design.' },
